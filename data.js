// Shared data, i18n, and room-rendering helpers for index.html and room.html
  ...
  const translations = {
    en: {
      ...
      'room.availableCities': 'Available Cities',
      'room.availableCitiesSoon': 'Coming soon',
      'room.availableCitiesEnglish': 'English version',
    ...
    zh: {
      ...
      'room.availableCities': '可玩城市',
      'room.availableCitiesSoon': '暂未开放',
      'room.availableCitiesEnglish': '有英文版',
  ...
  const ROOM_INFO = {
    '诺亚': { priceRMB: 338, hasEnglish: true, duration: 100, company: 'MRX', type: '科幻，精神病院，大型机关', typeEn: 'Sci-Fi, Mental Asylum, Large-Scale Mechanisms', players: '4-8', bookingRulesImage: 'images/mrx-booking-rules.jpg', storeName: 'X先生·沉浸密室 (悠唐购物中心店)', address: '朝外南街悠唐购物中心商场西区B1层（博纳影院左侧）', addressEn: 'B1F, West Zone, Youtang Shopping Center, Chaowai South Street (next to Broadway Cinema)', hours: '10:00-次日03:00', hoursEn: '10:00–03:00 (next day)', phone: '+86 155 0101 7536', bookingInfo: 'https://m.dianping.com/shopshare/jVUxlaILqoaxwbvv?msource=Appshare2021&utm_source=shop_share&shoptype=30&shopcategoryid=2754&isoversea=0&shareid=5RNlZyRN4s_1789393007', bookingRulesLink: 'http://dpurl.cn/Vj1UrhDz', availableCities: [{ zh: '北京', en: "Beijing", venue: 'X先生•沉浸密室（悠唐购物中心）', english: true }, { zh: '上海', en: "Shanghai", venue: '屋有岛沉浸游戏旗舰店（中山公园店）' }, { zh: '杭州', en: "Hangzhou", venue: 'MRX沉浸游戏•X先生密室逃脱（城西银泰店）' }, { zh: '深圳', en: "Shenzhen", venue: 'X先生沉浸游戏（MRX福田世纪汇店）' }, { zh: '成都', en: "Chengdu", venue: '屋有岛沉浸游戏体验馆（成都旗舰店）' }, { zh: '广州', en: "Guangzhou", venue: 'MRX•X先生密室逃脱（广州天河店）' }, { zh: '长沙', en: "Changsha", venue: '关你鬼室大型密室逃脱（黄兴广场店）' }], availableCitiesNote: '只有北京版本提供英文版。', availableCitiesNoteEn: 'Only the Beijing version is available in English.', availableCitiesSource: 'http://dpurl.cn/MsrOKcXz' },
    ...
    '溃烂缪斯': { priceRMB: 298, hasEnglish: true, duration: 90, company: 'Dreamland Traveller', type: '美式恐怖酒店，大型机关', typeEn: 'American Horror, Hotel, Large-Scale Mechanisms', players: '4-7', reviews: [{ url: 'https://escaperoomers.de/escape-room/corrupt-muse/' }], storeName: '梦境旅人·沉浸式电影密室 (北京路店)', address: '文明路61号3层 310室-360室-370室-386室', addressEn: '3F, No.61 Wenming Road, Rooms 310-360-370-386', hours: '12:00-次日00:30', hoursEn: '12:00–00:30 (next day)', bookingInfo: 'https://m.dianping.com/shopshare/G22Xb6Hwd8ycXwAE?msource=Appshare2021&utm_source=shop_share&shoptype=30&shopcategoryid=2754&isoversea=0&shareid=hpFboGDuBk_1789391448', phone: '+86 186 8943 2839', bookingRulesLink: 'http://dpurl.cn/8lDWy9lz', availableCities: [{ zh: '广州', en: "Guangzhou", venue: '梦境旅人沉浸剧场', english: true }, { zh: '杭州', en: "Hangzhou", venue: '自由城·超级密室（大象城店）', english: true }, { zh: '郑州', en: "Zhengzhou", venue: '无色城光影剧场（郑州店）' }, { zh: '长沙', en: "Changsha", venue: 'V厂逃脱标签.沉浸式实景游戏（长沙旗舰店）' }, { zh: '西安', en: "Xi'an", venue: '曼巴实景密室逃脱（桥梓口店）' }, { zh: '北京', en: "Beijing", venue: 'UMEPLAY逃脱艺术（朝阳店）', english: true }, { zh: '上海', en: "Shanghai", venue: 'UMEPLAY多感官实景游戏（天安千树店）', english: true }, { zh: '济南', en: "Jinan", venue: '般若·F超级密室' }, { zh: '武汉', en: "Wuhan", venue: 'NOX五感艺术' }, { zh: '深圳', en: "Shenzhen", venue: 'Whoosh沉浸式剧场（海岸城店）' }, { zh: '宁波', en: "Ningbo", venue: '九尾密室·逃脱艺术（天一广场店）' }, { zh: '苏州', en: "Suzhou", venue: '火星世界·超级密室（观前街店）' }, { zh: '昆明', en: "Kunming", venue: '星河旅人' }, { zh: '哈尔滨', en: "Harbin", venue: '微光Shimmer交互式演绎剧场' }, { zh: '成都', en: "Chengdu", venue: 'Monster 剧场' }, { zh: '太原', en: "Taiyuan", venue: '猫瞳演绎密室（柳巷贵都店）' }, { zh: '南京', en: "Nanjing", soon: true }, { zh: '台湾', en: "Taiwan", soon: true }, { zh: '韩国首尔', en: "Seoul, South Korea", venue: 'Immersive Studio（이머시브스튜디오）弘大2号剧场' }, { zh: '美国波士顿', en: "Boston, USA", soon: true }], availableCitiesNote: '上海、北京、杭州、广州版本提供英文版。', availableCitiesNoteEn: 'English versions are available in Shanghai, Beijing, Hangzhou and Guangzhou.', availableCitiesSource: 'http://dpurl.cn/m9io37tz' },
    ...
    '活神仙': { priceRMB: 238, hasEnglish: false, duration: 105, company: 'Dragon Gallery', type: '独栋密室，中式民俗', typeEn: 'Standalone Building, Chinese Folklore', reviews: [{ url: 'https://escaperoomers.de/escape-room/the-living-immortal/' }] },
