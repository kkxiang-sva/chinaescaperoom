// Shared data, i18n, and room-rendering helpers for index.html and room.html
  ...
  const translations = {
    en: {
      ...
      'room.bookingRulesLinkCta': 'Click here for translation service →',
      'room.bookingRulesLinkNote': "Note: the price shown on that page isn't real — don't worry, the translation service is actually free.",
    ...
    zh: {
      ...
      'room.bookingRulesLinkCta': '点击这里预约翻译服务 →',
      'room.bookingRulesLinkNote': '注：页面上显示的价格是假的，不用被吓到，翻译服务其实是免费的。',
